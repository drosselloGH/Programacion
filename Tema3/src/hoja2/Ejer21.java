...
//		
		...
		System.out.println("El salario más bajo es de "+nominas[filaMin][1]+" "+nominas[filaMin][0]+", con un salario de "+nominas[filaMin][2]+" euros");
		System.out.println("El salario más alto es de "+nominas[filaMax][1]+" "+nominas[filaMax][0]+", con un salario de "+nominas[filaMax][2]+" euros");
	}
